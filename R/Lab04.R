...
#zip("mydemw.zip",list.files(pattern="mydemw[:.:]")) for zipping shapefile if needed
...
source("https://raw.githubusercontent.com/nspacher/BSE5304Labs/main/R/TMWBFuncs.R")
source("https://raw.githubusercontent.com/nspacher/BSE5304Labs/main/R/TISnow.R")
