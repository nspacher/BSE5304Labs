...
#CNModel
#
CNModel <- function(BasinData, CNavg, IaFrac, fnc_slope, fnc_aspect, func_DAWC, func_z, fnc_fcres){
CNmodeldf = BasinData
# CNavg = 75
# IaFrac = 0.05
# fnc_slope=0 
...
detach(CNmodeldf)
return(data.frame(SNO=CNmodeldf$SNO, SNOmlt=CNmodeldf$SNOmlt, SnowfallWatEq_mm=CNmodeldf$SnowfallWatEq_mm,
