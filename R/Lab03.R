...
url="https://websoilsurvey.sc.egov.usda.gov/DSD/Download/AOI/nx3xvect4avmh0dzomnbf3kz/wss_aoi_2023-02-09_13-06-46.zip"
...
mysoil=readOGR("wss_aoi_2023-02-09_13-06-46/spatial/soilmu_a_aoi.shp")    
...
#same model again different initial parameters
bmlt12 = 0.0
bmlt6 = 3
SFTmp = 7
TMWB$bmlt = (bmlt6 + bmlt12)/2 + (bmlt6 - bmlt12)/2 *  sin(2*pi/365*(julian(TMWB$date,origin = as.Date("2000-01-01"))-81))
